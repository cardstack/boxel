 ...
 *   https://...           -> explicit URL
 */
export async function resolveWorkspace(ref, matrixClient) {
...
export async function listUserWorkspaces(matrixClient) {
 ...
 */
export async function getAllWorkspacesStatus(matrixClient) {
    const workspaces = await listUserWorkspaces(matrixClient);
