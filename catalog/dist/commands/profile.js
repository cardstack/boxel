...
import { getProfileManager, formatProfileBadge, getEnvironmentFromMatrixId, getEnvironmentShortLabel, getUsernameFromMatrixId, } from '../lib/profile-manager.js';
// ANSI color codes
...
export async function profileCommand(subcommand, arg, options) {
...
async function listProfiles(manager) {
...
async function addProfile(manager) {
...
async function switchProfile(manager, profileId) {
...
async function removeProfile(manager, profileId) {
...
async function addProfileNonInteractive(manager, matrixId, password, displayName) {
...
async function migrateFromEnv(manager) {
