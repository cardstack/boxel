...
```
.agents/skills/ember-best-practices/rules/route-parallel-model.md
.agents/skills/ember-best-practices/rules/bundle-embroider-static.md
.agents/skills/ember-best-practices/rules/a11y-automated-testing.md
```
...
For the complete guide with all rules expanded: `.agents/skills/ember-best-practices/AGENTS.md`
