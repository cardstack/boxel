...
module.skip('Unit | AnimationParticipantManager', function () {
  ...
  test('it performs cleanups before updating its managed AnimationParticipants', function () {});
  test('it can pass removals to the correct AnimationParticipants to handle', function () {});
  test('it can pass insertions + their associated DOMRefs to the correct AnimationParticipants to handle', function () {});
