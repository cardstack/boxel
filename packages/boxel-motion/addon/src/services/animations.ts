...
import { AnimationParticipantManager } from '../models/animation-participant.ts';
import { type IContext } from '../models/animator.ts';
import { type ISpriteModifier } from '../models/sprite.ts';
import TransitionRunner from '../models/transition-runner.ts';
