        ...
        'germaine.json': {
          data: {
            attributes: {
              ...
              cardDescription: 'Fancy Germaine',
            },
            meta: {
              adoptsFrom: {
                module: './fancy-person',
    ...
    if (vendor?.type === 'doc') {
      assert.deepEqual(vendor.doc, {
        data: {
          ...
          attributes: {
            name: 'Acme Industries',
            cardTitle: 'Acme Industries',
            cardDescription: 'Vendor',
            cardThumbnailURL: null,
            paymentMethods: [
              {
                type: 'crypto',
        ...
        included: [
          {
            ...
            attributes: {
              name: 'Ethereum Mainnet',
              cardTitle: 'Ethereum Mainnet',
              chainId: 1,
              cardDescription: `Chain 1`,
      ...
      contents: {
        'Publication/pacific.json': {
          data: {
            ...
            attributes: { cardTitle: 'Pacific Weekly' },
            relationships: {
        ...
        'Post/1.json': {
          data: {
            ...
            attributes: {
              cardTitle: '50 Ways to Leave Your Laptop',
              views: 5,
            },
            relationships: {
              publication: {
      ...
      contents: {
        ...
        'pet-person-spec.json': {
          data: {
            attributes: {
              cardTitle: 'PetPerson',
              cardDescription: 'Spec for PetPerson',
              specType: 'card',
              ref: {
                module: `${testModuleRealm}pet-person`,
                name: 'PetPerson',
      ...
      contents: {
        'Friend/hassan.json': {
          data: {
            ...
            attributes: {
              firstName: 'Hassan',
              cardDescription: 'Friend of dogs',
            },
            relationships: {
              friend: {
                links: {
  ...
  test("indexing identifies an instance's card references", async function (assert) {
    ...
    assert.deepEqual(
      ...
      [
        ...
        'http://localhost:4206/@cardstack/boxel-icons/v1/icons/info-circle',
