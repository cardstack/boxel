  ...
  test("indexing identifies an instance's card references", async function (assert) {
    ...
    assert.deepEqual(
      ...
      [
        ...
        'https://shimmed-module/@cardstack/boxel-ui/components',
        'https://shimmed-module/@cardstack/boxel-ui/helpers',
        'https://shimmed-module/@cardstack/boxel-ui/icons',
        'https://shimmed-module/@cardstack/runtime-common',
        'https://shimmed-module/@ember/component',
        'https://shimmed-module/@ember/component/template-only',
        'https://shimmed-module/@ember/helper',
        'https://shimmed-module/@ember/modifier',
        'https://shimmed-module/@ember/object',
        'https://shimmed-module/@ember/template-factory',
        'https://shimmed-module/@glimmer/component',
        'https://shimmed-module/@glimmer/tracking',
        'https://shimmed-module/ember-concurrency',
        'https://shimmed-module/ember-concurrency/-private/async-arrow-runtime',
        'https://shimmed-module/ember-modifier',
        'https://shimmed-module/lodash',
        'https://shimmed-module/tracked-built-ins',
      ],
