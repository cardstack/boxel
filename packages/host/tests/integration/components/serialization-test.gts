...
module('Integration | serialization', function (hooks) {
  ...
  module('computed linksTo', function () {
    ...
    skip(
      'can deserialize a computed linksTo relationship that points to own card class'
    );
  });
  ...
  module('computed linksToMany', function () {
    test('can serialize', async function (assert) {
    ...
    skip(
      'can serialize a computed linksToMany relationship that points to own card class'
    );
    skip(
      'can deserialize a computed linksToMany relationship that points to own card class'
    );
  });
});
