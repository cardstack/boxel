...
module('Integration | create app module via ai-assistant', function (hooks) {
  ...
  skip('it can create a module using a tool call', async function (assert) {
      ...
      contents: {
        'PRD/1.json': {
          data: {
            ...
            meta: {
              adoptsFrom: {
                module: `https://cardstack.com/catalog/product-requirement-document`,
    ...
    let skillEventId = getRoomState(roomId, APP_BOXEL_ROOM_SKILLS_EVENT_TYPE)
      .enabledEventIds[0];
