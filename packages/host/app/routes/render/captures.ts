...
import type { DeclaredCaptureRoster } from '@cardstack/runtime-common';
...
export type Model = { roster: DeclaredCaptureRoster } | undefined;

// Lightweight sibling of render.types: returns the card's merged
// `static captures` declarations in serialized form so the capture
...
export default class RenderCapturesRoute extends Route<Model> {
