...
curl http://localhost:8008/_matrix/client/v3/register/available\?username\=realm_server
ts-node --transpileOnly ./scripts/register-realm-user.ts node-test_realm-server
curl http://localhost:8008/_matrix/client/v3/register/available\?username\=node-test_realm-server
ts-node --transpileOnly ./scripts/register-realm-user.ts base_realm
curl http://localhost:8008/_matrix/client/v3/register/available\?username\=base_realm
ts-node --transpileOnly ./scripts/register-realm-user.ts experiments_realm
curl http://localhost:8008/_matrix/client/v3/register/available\?username\=experiments_realm
