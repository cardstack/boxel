...
module('Unit | Behaviors | Spring', function () {
  test('generates minimum of 2 frames', function (assert) {
    ...
    assert.deepEqual(spring.toFrames({ from: 0, to: 1 }), [
      {
        value: 0,
        velocity: 0,
      },
    ...
    assert.deepEqual(spring.toFrames({ from: 1, to: 0 }), [
      {
        value: 1,
        velocity: 0,
      },
  ...
  test('does nothing when from and to are the same', function (assert) {
    ...
    assert.deepEqual(behavior.toFrames({ from: 1, to: 1 }), []);
    assert.deepEqual(behavior.toFrames({ from: 0, to: 0 }), []);
  });

  test('handles from and to being the same with an initial velocity', function (assert) {
    let behavior = new SpringBehavior();

    assert.deepEqual(behavior.toFrames({ from: 0, to: 0, velocity: -0.01 }), [
      {
        value: 0,
        velocity: 0.01,
      },
  ...
  test('overshootClamping prevents the spring from exceeding its target value', function (assert) {
    ...
    assert.deepEqual(unclampedSpring.toFrames({ from: 0, to: 1 }), [
      {
        value: 0,
        velocity: 0,
      },
    ...
    assert.deepEqual(clampedSpring.toFrames({ from: 0, to: 1 }), [
      {
        value: 0,
        velocity: 0,
      },
  ...
  test('underdamped spring', function (assert) {
    ...
    assert.deepEqual(underdampedSpring.toFrames({ from: 0, to: 1 }), [
      {
        value: 0,
        velocity: 0,
      },
  ...
  test('critically damped spring', function (assert) {
    ...
    assert.deepEqual(criticallydampedSpring.toFrames({ from: 0, to: 1 }), [
      {
        value: 0,
        velocity: 0,
      },
  ...
  test('overdamped spring', function (assert) {
    ...
    assert.deepEqual(overdampedSpring.toFrames({ from: 0, to: 1 }), [
      {
        value: 0,
        velocity: 0,
      },
    ...
    assert.deepEqual(
      overdampedSpringWithoutOverdamping.toFrames({ from: 0, to: 1 }),
      [
        {
          value: 0,
          velocity: 0,
    ...
    assert.deepEqual(
      overdampedSpringWithoutOverdamping.toFrames({ from: 0, to: 1 }),
      criticallydampedSpring.toFrames({ from: 0, to: 1 })
    );
  });
  ...
  test('takes a delay into account', function (assert) {
    ...
    let frames = clampedSpring.toFrames({ from: 0, to: 1, delay: 50 });
  ...
  test('takes previous velocity into account', function (assert) {
    ...
    let frames = clampedSpring.toFrames({ from: 0, to: 1, velocity: 0.01 });
    ...
    frames = clampedSpring.toFrames({ from: 0, to: 1, velocity: -0.01 });
    ...
    frames = clampedSpring.toFrames({ from: 0, to: 1, velocity: -1 });
