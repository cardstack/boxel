    ...
    let app = new Koa<Koa.DefaultState, Koa.Context>()
      ...
      .use(
        cors({
          ...
          // bytes flow.
          allowHeaders:
            'Authorization, Content-Type, If-Match, If-None-Match, If-Range, Range, X-Requested-With, X-Boxel-Client-Request-Id, X-Boxel-Assume-User, X-HTTP-Method-Override, X-Boxel-Disable-Module-Cache, X-Filename, X-Boxel-During-Prerender, X-Boxel-Skip-Index-Wait, X-Boxel-Lattice-Input-Generation, X-Boxel-Lattice-Have, X-Boxel-Lattice-Priority, X-Boxel-Consuming-Realm, X-Boxel-Job-Id, X-Boxel-Job-Priority, X-Boxel-Logging-Correlation-Id, X-Grafana-Device-Id, X-Grafana-Action',
