      ...
      pgm.sql(
        `INSERT INTO realm_user_permissions (realm_url, username, read, write, realm_owner)
         VALUES
           ...
           ('https://realms-staging.stack.cards/experiments/', '*', true, true, false),
      ...
      pgm.sql(
        `INSERT INTO realm_user_permissions (realm_url, username, read, write, realm_owner)
         VALUES
           ...
           ('https://app.boxel.ai/experiments/', '*', true, true, false),
      ...
      pgm.sql(
        `INSERT INTO realm_user_permissions (realm_url, username, read, write, realm_owner)
         VALUES
           ...
           ('http://localhost:4201/experiments/', '*', true, true, false),
           ...
           ('http://localhost:4204/', '*', true, true, false),
