...
describe("transpile-test.ts", function () {
    describe('Transpile', function () {
        test('can rewrite fetch()', async function () {
    ...
    test('can rewrite import() that has url like argument', async function () {
        let transpiled = await transpileJS(`
      async function test() {
    ...
    test('can rewrite import() that has module specifier argument', async function () {
        let transpiled = await transpileJS(`
      async function test() {
