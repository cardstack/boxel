  ...
  describe('publish and unpublish realm tests', function () {
    ...
    describe('with a publishable source realm', function () {
      ...
      it('POST /_publish-realm can publish realm successfully', async function () {
        ...
        expect(response.body.data.attributes.sourceRealmURL).toBe(
        ...
        expect(publishedLastPublishedAt).toBe(
      ...
      it('publishing rewrites hostHome URLs that point to the source realm', async function () {
        ...
        expect(publishedRealmConfig.hostHome).toBe(
      ...
      it('POST /_publish-realm can republish realm with updated timestamp', async function () {
        ...
        expect(secondResponse.body.data.attributes.publishedRealmURL).toBe(
          firstResponse.body.data.attributes.publishedRealmURL,
        );
        expect(secondResponse.body.data.attributes.lastPublishedAt).not.toEqual(
          firstTimestamp,
        );
      ...
      it('POST /_unpublish-realm can unpublish realm successfully', async function () {
        ...
        expect(unpublishResponse.body.data.id).toBe(
          publishResponse.body.data.id,
        );
        expect(unpublishResponse.body.data.attributes.sourceRealmURL).toBe(
          sourceRealmUrlString,
        );
        expect(unpublishResponse.body.data.attributes.publishedRealmURL).toBe(
          publishedRealmURL,
        );
        expect(
      ...
      it('POST /_unpublish-realm returns forbidden for user without realm-owner permission', async function () {
        ...
        let response = await request
          ...
          .set(
            'Authorization',
            `Bearer ${createRealmServerJWT({ user: nonOwnerUserId, sessionRoom: 'session-room-test' }, realmSecretSeed)}`,
          )
          .send(
            JSON.stringify({
              publishedRealmURL: publishedRealmURL,
      ...
      it('POST /_publish-realm does not create duplicate realm instances on republish', async function () {
        ...
        expect(republishAfterUnpublishResponse.body.data.id).not.toEqual(
