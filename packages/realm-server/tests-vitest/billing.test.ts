    ...
    describe('billing', function () {
        ...
        describe('invoice payment succeeded', function () {
            describe('new subscription without any previous subscription', function () {
                it('creates a new subscription and adds plan allowance in credits', async function () {
            ...
            describe('subscription update', function () {
                it('updates the subscription and prorates credits', async function () {
                    let user = await insertUser(dbAdapter, 'user@test', 'cus_123', 'user@test.com');
            ...
            describe('subscription cycle', function () {
                it('renews the subscription', async function () {
                    let user = await insertUser(dbAdapter, 'user@test', 'cus_123', 'user@test.com');
        ...
        describe('subscription deleted', function () {
            it('handles subscription cancellation', async function () {
                let user = await insertUser(dbAdapter, 'user@test', 'cus_123', 'user@test.com');
                let plan = await insertPlan(dbAdapter, 'Creator', 12, 2500, 'prod_creator');
                let subscription = await insertSubscription(dbAdapter, {
                    user_id: user.id,
        ...
        describe('checkout session completed', function () {
            ...
            describe('user has a subscription', function () {
                it('add extra credits to user ledger when checkout session completed', async function () {
        ...
        describe('AI usage tracking', function () {
            ...
            it('spends ai credits correctly when no extra credits are available', async function () {
            ...
            it('does not spend previous cycle plan allowance in current cycle', async function () {
                await addToCreditsLedger(dbAdapter, {
                    userId: user.id,
                    creditAmount: 100,
                    creditType: 'plan_allowance',
            ...
            it('spends ai credits correctly when extra credits are available', async function () {
                // User receives 2500 credits for the creator plan and spends 2490 credits
                await addToCreditsLedger(dbAdapter, {
                    userId: user.id,
                    creditAmount: creatorPlan.creditsIncluded,
            ...
            it('spends ai credits using daily credits before extra credits', async function () {
                await addToCreditsLedger(dbAdapter, {
                    userId: user.id,
                    creditAmount: 5,
                    creditType: 'plan_allowance',
        ...
        describe('AI usage tracking without subscription', function () {
            ...
            it('spends daily credits before extra credits on free plan', async function () {
                await addToCreditsLedger(dbAdapter, {
                    userId: user.id,
                    creditAmount: 4,
                    creditType: 'daily_credit',
        ...
        describe('daily credit grant', function () {
            it('grants credits when user falls below the threshold', async function () {
            ...
            it('does not grant twice on the same day', async function () {
            ...
            it('does not grant when user already meets threshold', async function () {
