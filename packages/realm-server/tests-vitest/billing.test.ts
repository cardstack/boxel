    ...
    describe('invoice payment succeeded', function () {
      describe('new subscription without any previous subscription', function () {
        it('creates a new subscription and adds plan allowance in credits', async function () {
          ...
          expect(stripeEvents[0].stripe_event_id).toBe(
          ...
          expect(subscriptionCycle.periodStart).toBe(
            stripeInvoicePaymentSucceededEvent.data.object.period_start,
          );
          expect(subscriptionCycle.periodEnd).toBe(
          ...
          expect(creditLedgerEntry.subscriptionCycleId).toBe(
      ...
      describe('subscription update', function () {
        it('updates the subscription and prorates credits', async function () {
          ...
          expect(subscriptionCycles.length).toBe(1);
          expect(subscriptionCycles[0].periodStart).toBe(
            stripeInvoicePaymentSucceededEvent.data.object.period_start,
          );
          expect(subscriptionCycles[0].periodEnd).toBe(
            stripeInvoicePaymentSucceededEvent.data.object.period_end,
          );
