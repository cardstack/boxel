...
describe('atomic-endpoints-test.ts', function () {
  describe('Realm-specific Endpoints: can make request to post /_atomic', function () {
    ...
    describe('writes', function () {
      ...
      it('can write single new module', async function () {
        let source = `
      ...
      it('can write multiple new modules', async function () {
        let place1Source = `
              import { field, CardDef, contains } from "https://cardstack.com/base/card-api";
              import StringField from "https://cardstack.com/base/string";
              export class Place extends CardDef {
      ...
      it('can write a single instance', async function () {
        let doc = {
          'atomic:operations': [
            {
              op: 'add',
      ...
      it('can write multiple instances', async function () {
        let doc = {
          'atomic:operations': [
            {
              op: 'add',
      ...
      it('can write multiple modules that depend on each other', async function () {
        let place1Source = `
            import { field, CardDef, contains } from "https://cardstack.com/base/card-api";
            import StringField from "https://cardstack.com/base/string";
            export class Place extends CardDef {
      ...
      it('can write multiple instances that depend on each other', async function () {
        let placeSource = `
      ...
      it('can write new instance with new module', async function () {
        let source = `
            import { field, CardDef, contains } from "https://cardstack.com/base/card-api";
            import StringField from "https://cardstack.com/base/string";
            export class Place extends CardDef {
      ...
      it('update is a no-op when content is unchanged', async function () {
        let source = `
              import { field, CardDef, contains } from "https://cardstack.com/base/card-api";
              import StringField from "https://cardstack.com/base/string";
              export class Place extends CardDef {
        ...
        try {
          ...
          expect(
            await testRealmAdapter.lastModified('place-modules/place-noop.gts'),
