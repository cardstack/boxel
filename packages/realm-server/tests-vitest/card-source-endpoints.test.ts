    ...
    describe('Realm-specific Endpoints | card source requests', function () {
        ...
        describe('card source GET request', function () {
            ...
            describe('public readable realm', function () {
                ...
                test('caches responses and invalidates on write', async function () {
                ...
                test('supports noCache query param to bypass cache', async function () {
                ...
                test('serves a card-source GET request that results in redirect', async function () {
                    let response = await request
                        .get('/person')
                        .set('Accept', 'application/vnd.card+source');
                ...
                test('serves a card instance GET request with card-source accept header that results in redirect', async function () {
                    let response = await request
                        .get('/person-1')
                        .set('Accept', 'application/vnd.card+source');
                    expect(response.status).toBe(302);
                ...
                test('serves source of a card module that is in error state', async function () {
                    let response = await request
                ...
                test('serves a card instance GET request with a .json extension and json accept header that results in redirect', async function () {
                    let response = await request
                        .get('/person.json')
                ...
                test('serves a module GET request', async function () {
        ...
        describe('card source HEAD request', function () {
            ...
            describe('public readable realm', function () {
                ...
                test('serves a card-source HEAD request that results in redirect', async function () {
                    let response = await request
                        .head('/person')
                        .set('Accept', 'application/vnd.card+source');
                    expect(response.status).toBe(302);
                ...
                test('serves a card-source HEAD request for a regular file without redirect', async function () {
        ...
        describe('card-source DELETE request', function () {
            ...
            describe('public writable realm', function () {
                ...
                test('serves a card-source DELETE request for a card instance', async function () {
                    let entry = 'person-1';
                    let response = await request
                        .delete('/person-1')
                        .set('Accept', 'application/vnd.card+source');
        ...
        describe('card-source POST request', function () {
            ...
            describe('public writable realm', function () {
                ...
                let { getMessagesSince } = setupMatrixRoom(hooks, getRealmSetup);
                test('serves a card-source POST request', async function () {
                    let entry = 'unused-card.gts';
                    let response = await request
          ...
          ${cardSrc}`);
                ...
                test('serves a card-source POST request for a .txt file', async function () {
                    let response = await request
                ...
                test('removes file meta on delete', async function () {
                ...
                test('can serialize a card instance correctly after card definition is changed', async function () {
                    let realmEventTimestampStart = Date.now();
                    // create a card def
                    {
                        let response = await request
            ...
            describe('public writable realm with size limit', function () {
                ...
                test('returns 413 when source payload exceeds size limit', async function () {
        ...
        describe('binary file POST request', function () {
            ...
            describe('public writable realm', function () {
                ...
                let { getMessagesSince } = setupMatrixRoom(hooks, getRealmSetup);
                test('serves a binary file POST request', async function () {
                ...
                test('creates file metadata for binary upload', async function () {
                ...
                test('overwrites existing binary file', async function () {
                ...
                test('broadcasts realm events for binary upload', async function () {
                    let realmEventTimestampStart = Date.now();
                    await request
                        .post('/event-test.bin')
                        .set('Content-Type', 'application/octet-stream')
            ...
            describe('public writable realm with size limit for binary', function () {
                ...
                test('returns 413 when binary payload exceeds size limit', async function () {
            ...
            describe('permissioned realm for binary', function () {
                ...
                test('401 without a JWT for binary upload', async function () {
                    let response = await request
                        .post('/secret.bin')
                        .set('Content-Type', 'application/octet-stream')
                ...
                test('403 without permission for binary upload', async function () {
                    let response = await request
                        .post('/secret.bin')
                        .set('Content-Type', 'application/octet-stream')
                        .send(Buffer.from(new Uint8Array([0x01])))
                ...
                test('204 with permission for binary upload', async function () {
                    let response = await request
                        .post('/secret.bin')
                        .set('Content-Type', 'application/octet-stream')
                        .send(Buffer.from(new Uint8Array([0x01])))
