    ...
    describe('Realm-specific Endpoints | card source requests', function () {
            ...
            describe('public readable realm', function () {
                ...
                it('serves source of a card module that is in error state', async function () {
                    let response = await request
                        ...
                        .set('Accept', 'application/vnd.card+source');
                    expect(response.headers['content-type']).toBe('text/typescript+glimmer');
        ...
        describe('binary file POST request', function () {
            ...
            describe('public writable realm', function () {
                ...
                it('card source GET returns correct content-type for image files', async function () {
                ...
                it('card source GET returns correct content-type for PDF files', async function () {
                ...
                it('card source GET returns correct content-type for audio files', async function () {
                ...
                it('card source GET returns correct content-type for video files', async function () {
