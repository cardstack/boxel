...
describe("card-endpoints-test.ts", function () {
    describe('Realm-specific Endpoints | card URLs', function () {
        ...
        describe('card GET request', function () {
            ...
            describe('public readable realm', function () {
                ...
                test('serves a card error request without last known good state', async function () {
                    let response = await request
                        .get('/missing-link')
                        .set('Accept', 'application/vnd.card+json');
                ...
                test('includes FileDef resources for file links in included payload', async function () {
              ...
              `,
                ...
                test('linksTo relationship for CardDef uses card type not file-meta', async function () {
             ...
             AND type = 'instance'`);
                ...
                test('stale linksTo(FileDef subclass) relationship data.type of card is corrected to file-meta', async function () {
                    let { testRealm: realm, request, dbAdapter } = getRealmSetup();
             ...
             AND type = 'instance'`);
                ...
                test('card-level query-backed relationships resolve via search at read time', async function () {
              ...
              `,
                ...
                test('field-level query-backed relationships resolve at read time (nested contains)', async function () {
                    let { testRealm: realm, request } = getRealmSetup();
                    let writes = new Map<string, string>([
                        [
            ...
            describe('public writable realm', function () {
                ...
                test('serves a card error request with last known good state', async function () {
                    await request
                        .patch('/hassan')
                        .send({
                        data: {
            ...
            describe('permissioned realm', function () {
                ...
                test('200 when server user assumes user that has read permission', async function () {
                    let response = await request
                        .get('/person-1')
                        .set('Accept', 'application/vnd.card+json')
                ...
                test('403 when server user assumes user that has no read permission', async function () {
                    let response = await request
                        .get('/person-1')
                        .set('Accept', 'application/vnd.card+json')
        ...
        describe('card POST request', function () {
            ...
            describe('public writable realm', function () {
                ...
                test('creates card instances when it encounters "lid" in the request', async function () {
                    let response = await request
                        .post('/')
                        .send({
                        data: {
                ...
                test('ignores "lid" for other realms', async function () {
                    let response = await request
                        .post('/')
                        .send({
                        data: {
                ...
                test('creates card instance when it encounters "lid" in the primary resource', async function () {
                    let response = await request
                        .post('/')
                        .send({
                        data: {
            ...
            describe('permissioned realm', function () {
                ...
                test('401 permissions have been updated', async function () {
                    let response = await request
                        .post('/')
                        .send({})
                        .set('Accept', 'application/vnd.card+json')
                ...
                test('201 with permission', async function () {
                    let response = await request
                        .post('/')
                        .send({
                        data: {
        ...
        describe('card PATCH request', function () {
            ...
            describe('public writable realm', function () {
                ...
                test('no-op patch returns existing lastModified and does not rewrite file', async function () {
                ...
                test('patches card when index entry is an error using pristine doc', async function () {
               ...
               WHERE url = $2`, {
                ...
                test('patches card when index entry is an error without pristine doc', async function () {
                    let cardURL = `${testRealmHref}person-1`;
                    let errorDoc = {
                        message: 'render failed',
                        status: 500,
               ...
               WHERE url = $2`, {
                ...
                test('creates card instances when it encounters "lid" in the request for requests that has "isUsed: true" links', async function () {
                    let response = await request
                        .patch('/hassan-x')
                        .send({
                        data: {
            ...
            describe('public writable realm with size limit', function () {
                ...
                test('returns 413 when card payload exceeds size limit', async function () {
        ...
        describe('card DELETE request', function () {
            ...
            describe('public writable realm', function () {
                ...
                test('serves a card DELETE request with .json extension in the url', async function () {
                    let entry = 'person-1.json';
                    let response = await request
                ...
                test('removes card JSON file meta when card is deleted', async function () {
            ...
            describe('permissioned realm', function () {
                ...
                test('204 with permission', async function () {
                    let response = await request
                        .delete('/person-1')
                        .set('Accept', 'application/vnd.card+json')
                        .set('Authorization', `Bearer ${createJWT(testRealm, 'john', ['read', 'write'])}`);
        ...
        describe('file URLs', function () {
            ...
            test('rejects HTTP requests to file URLs', async function () {
                let response;
                response = await request
                    .get('/greeting.txt')
                    .set('Accept', 'application/vnd.card+json');
    ...
    describe('Query-backed relationships runtime resolver', function () {
        ...
        test('linksTo query resolves the first aggregated result and includes it', async function () {
        ...
        test('linksToMany query returns remote results and records errors for failing realm', async function () {
            let response = await consumerRequest
                .get('/favorite')
                .set('Accept', 'application/vnd.card+json');
            expect(response.status).toBe(200);
