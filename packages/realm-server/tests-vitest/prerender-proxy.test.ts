...
describe("prerender-proxy-test.ts", function () {
    describe('prerender proxy', function () {
        ...
        test('proxies prerender requests to the configured prerenderer', async function () {
        ...
        test('returns an error when no upstream is configured', async function () {
            let app = new Koa();
            let router = new Router();
            router.post('/_prerender-card', jwtMiddleware(realmSecretSeed), handlePrerenderProxy({
                kind: 'card',
        ...
        test('returns unauthorized when no token is provided', async function () {
        ...
        test('proxies to prerender server card and module endpoints', async function () {
            let { prerenderer, renderCalls } = makePrerenderer();
