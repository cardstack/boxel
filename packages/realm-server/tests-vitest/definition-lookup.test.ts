...
describe("definition-lookup-test.ts", function () {
    describe('DefinitionLookup', function () {
        ...
        test('lookupDefinition', async function () {
        ...
        test('invalidates module cache entries without file extensions', async function () {
            let definition = await definitionLookup.lookupDefinition({
                module: `${realmURL}person.gts`,
                name: 'Person',
            });
        ...
        test('invalidates cached module after module update', async function () {
        ...
        test('invalidates cached module after module deletion', async function () {
            await dbAdapter.execute('DELETE FROM modules');
        ...
        test('invalidates module cache entries for branching dependency graph', async function () {
            await dbAdapter.execute('DELETE FROM modules');
        ...
        test('propagates module errors to dependents and recovers after missing modules are added', async function () {
            await dbAdapter.execute('DELETE FROM modules');
            let deepModule = `${realmURL}deep-card.gts`;
            let middleModule = `${realmURL}middle-field.gts`;
            let leafModule = `${realmURL}leaf-field.gts`;
        ...
        test('uses public cache scope when realm is public', async function () {
            await dbAdapter.execute('DELETE FROM modules');
        ...
        test('uses realm-auth cache scope when realm is private on the same server', async function () {
            await dbAdapter.execute('DELETE FROM modules');
            await definitionLookup.lookupDefinition({
                module: `${realmURL}person.gts`,
                name: 'Person',
        ...
        test('uses public cache scope when requesting a public realm on another server', async function () {
            await dbAdapter.execute('DELETE FROM modules');
        ...
        test('uses realm-auth cache scope when requesting a private realm on another server', async function () {
            await dbAdapter.execute('DELETE FROM modules');
