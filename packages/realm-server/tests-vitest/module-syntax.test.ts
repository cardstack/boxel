...
describe("module-syntax-test.ts", function () {
    describe('module-syntax', function () {
        ...
        test('can get the code for a card', async function () {
            let src = `
    ...
    `;
      ...
      `);
        ...
        test('added field respects indentation of previous field', async function () {
            // 4 space indent
            let mod = addField(`
        import { contains, field, Component, CardDef } from "https://cardstack.com/base/card-api";
        import StringField from "https://cardstack.com/base/string";
      ...
      `);
        ...
        test('added field respects indentation of previous class member', async function () {
            // 2 space indent
            let mod = addField(`
        import { contains, field, Component, CardDef } from "https://cardstack.com/base/card-api";
        import StringField from "https://cardstack.com/base/string";
      ...
      `);
        ...
        test(`added field defaults to a 2 space indent if it's the only class member`, async function () {
            let mod = addField(`
      import { contains, field, Component, CardDef } from "https://cardstack.com/base/card-api";
      import StringField from "https://cardstack.com/base/string";
      export class Person extends CardDef {
      ...
      `);
        ...
        test(`added field respects the indentation of the next field when adding field at specific position`, async function () {
            // 4 space indent
            let mod = addField(`
        import { contains, field, Component, CardDef } from "https://cardstack.com/base/card-api";
        import StringField from "https://cardstack.com/base/string";
      ...
      `);
        ...
        test('can add a base-card field to a card', async function () {
            let src = `
    ...
    `;
      ...
      `);
        ...
        test('can add a base-field field to a card', async function () {
            let src = `
      import { contains, field, CardDef } from "https://cardstack.com/base/card-api";
      import StringField from "https://cardstack.com/base/string";
      export class Pet extends CardDef {
    ...
    `;
      ...
      `);
        ...
        test('can add a field to a card when the module url is relative', async function () {
            let src = `
      import { contains, field, CardDef } from "https://cardstack.com/base/card-api";
      import StringField from "https://cardstack.com/base/string";
      export class Pet extends CardDef {
    ...
    `;
      ...
      `);
        ...
        test('can add a field to a card when the module url is from another realm', async function () {
            let src = `
      import { contains, field, CardDef } from "https://cardstack.com/base/card-api";
      import StringField from "https://cardstack.com/base/string";
      export class Pet extends CardDef {
    ...
    `;
      ...
      `);
        ...
        test("can add a field to a card that doesn't have any fields", async function () {
            let src = `
      ...
      `;
        ...
        test('can add a field to an interior card that is the field of card that is exported', async function () {
            let src = `
      import { contains, field, Component, CardDef } from "https://cardstack.com/base/card-api";
      import StringField from "https://cardstack.com/base/string";
    ...
    `;
      ...
      `);
        ...
        test('can add a field to an interior card that is the ancestor of card that is exported', async function () {
            let src = `
      import { contains, field, Component, CardDef } from "https://cardstack.com/base/card-api";
      import StringField from "https://cardstack.com/base/string";
    ...
    `;
      ...
      `);
        ...
        test('can add a field to an interior card within a module that also has non card declarations', async function () {
            let src = `
      import { contains, field, Component, CardDef } from "https://cardstack.com/base/card-api";
      import StringField from "https://cardstack.com/base/string";
    ...
    `;
      ...
      `);
        ...
        test('can add a containsMany field', async function () {
            let src = `
      import { contains, field, Component, CardDef } from "https://cardstack.com/base/card-api";
      import StringField from "https://cardstack.com/base/string";
    ...
    `;
      ...
      `);
        ...
        test('can add a linksTo field', async function () {
            let src = `
      import { contains, field, CardDef } from "https://cardstack.com/base/card-api";
      import StringField from "https://cardstack.com/base/string";
      export class Person extends CardDef {
    ...
    `;
      ...
      `);
        ...
        test('can add a linksTo field with the same type as its enclosing card', async function () {
            let src = `
      import { contains, field, CardDef } from "https://cardstack.com/base/card-api";
      import StringField from "https://cardstack.com/base/string";
    ...
    `;
      ...
      `);
        ...
        test('can add a contains field with a computed value', async function () {
            let src = `
      import { contains, field, CardDef } from "https://cardstack.com/base/card-api";
      import StringField from "https://cardstack.com/base/string";
      ...
      `);
        ...
        test('can handle field card declaration collisions when adding field', async function () {
            let src = `
      import { contains, field, CardDef } from "https://cardstack.com/base/card-api";
      import StringField from "https://cardstack.com/base/string";
    ...
    `;
      ...
      `);
        ...
        test('throws when adding a field with a name the card already has', async function () {
            let src = `
      import { contains, field, CardDef } from "https://cardstack.com/base/card-api";
      import StringField from "https://cardstack.com/base/string";
    ...
    `;
        ...
        test('can remove a field from a card', async function () {
            let src = `
      import { contains, field, CardDef } from "https://cardstack.com/base/card-api";
      import StringField from "https://cardstack.com/base/string";
    ...
    `;
      ...
      `.trim());
        ...
        test('can use remove & add a field to achieve edit in place', async function () {
            let src = `
      import { contains, field, CardDef } from "https://cardstack.com/base/card-api";
      import StringField from "https://cardstack.com/base/string";
    ...
    `;
      ...
      `);
        ...
        test('can use remove & add a field to achieve edit in place - when field is at the beginning', async function () {
            let src = `
      import { contains, field, CardDef } from "https://cardstack.com/base/card-api";
      import StringField from "https://cardstack.com/base/string";
    ...
    `;
      ...
      `);
        ...
        test('can use remove & add a field to achieve edit in place - when field is at the end', async function () {
            let src = `
      import { contains, field, CardDef } from "https://cardstack.com/base/card-api";
      import StringField from "https://cardstack.com/base/string";
    ...
    `;
      ...
      `);
        ...
        test('can remove the last field from a card', async function () {
            let src = `
      import { contains, field, CardDef } from "https://cardstack.com/base/card-api";
      import StringField from "https://cardstack.com/base/string";
    ...
    `;
      ...
      `);
        ...
        test('can remove a linksTo field with the same type as its enclosing card', async function () {
            let src = `
      import { contains, field, CardDef, linksTo } from "https://cardstack.com/base/card-api";
      import StringField from "https://cardstack.com/base/string";
    ...
    `;
      ...
      `);
        ...
        test('can remove the field of an interior card that is the ancestor of a card that is exported', async function () {
            let src = `
      import { contains, field, Component, CardDef } from "https://cardstack.com/base/card-api";
      import StringField from "https://cardstack.com/base/string";
    ...
    `;
      ...
      `);
        ...
        test('can remove the field of an interior card that is the field of a card that is exported', async function () {
            let src = `
      import { contains, field, Component, CardDef } from "https://cardstack.com/base/card-api";
      import StringField from "https://cardstack.com/base/string";
    ...
    `;
      ...
      `);
        ...
        test('throws when field to remove does not actually exist', async function () {
            let src = `
      import { contains, field, Component, CardDef } from "https://cardstack.com/base/card-api";
      import StringField from "https://cardstack.com/base/string";
    ...
    describe('module-cache-invalidation', function () {
        test('extracts dependency keys from import and export specifiers via AST parsing', function () {
            let source = `
    ...
    describe('gjs-to-placeholder', function () {
        ...
        for (let example of examples) {
            test('round-trip gjs placeholders', async function () {
                expect(placeholderJSToGJS(gjsToPlaceholderJS(example))).toBe(example);
            });
        }
        test('preserves line numbers', function () {
            let src = `
        console.log(
          <template>
            Hi
