...
export class MyCard extends CardDef {
  @field name = contains(StringField);
      ...
      performance.assertion(benchmark);
    });
...
`);
      ...
      expect(responseJson.output)
        .toBe(`import StringField from 'https://cardstack.com/base/string';
...
`);
      ...
      let responseJson = JSON.parse(response.text);
      expect(responseJson.output)
        .toBe(`import { eq } from '@cardstack/boxel-ui/helpers';
...
@field name=contains(StringField);
      ...
      let responseJson = JSON.parse(response.text);
      expect(responseJson.output)
        .toBe(`import { CardDef, field, contains } from 'https://cardstack.com/base/card-api';
import { StringField } from 'https://cardstack.com/base/string';
export class MyCard extends CardDef {
  @field name = contains(StringField);
}
