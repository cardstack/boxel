...
describe("boxel-domain-availability-test.ts", function () {
    describe('boxel domain availability endpoint', function () {
        ...
        test('should return 422 when subdomain is missing', async function () {
        ...
        test('should return 200 with error for invalid subdomains', async function () {
        ...
        test('should return 200 with available=true for valid unclaimed subdomains', async function () {
        ...
        test('should return 200 with available=false for claimed subdomains', async function () {
        ...
        test('should return available=true for removed/unclaimed subdomains', async function () {
