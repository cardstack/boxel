...
describe("file-watcher-events-test.ts", function () {
    describe('file watcher realm events', function () {
      ...
      `,
        ...
        test('file creation produces an added event', async function () {
        ...
        test('file updating produces an updated event', async function () {
            realmEventTimestampStart = Date.now();
        ...
        test('file deletion produces a removed event', async function () {
            realmEventTimestampStart = Date.now();
        ...
        test('file watcher invalidates caches after external edits', async function () {
