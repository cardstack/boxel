...
describe("prerendering-test.ts", function () {
    describe('prerender - mutating tests', function () {
        ...
        test('reuses pooled page and picks up updated instance', async function () {
        ...
        test('module prerender reuses pooled page after updates', async function () {
        ...
        test('module prerender surfaces syntax errors', async function () {
        ...
        test('file extract surfaces broken FileDef module error without remote prerender timeout', async function () {
    ...
    function defineNonMutatingRunnerTests() {
        describe('runner behavior', function () {
            ...
            test('resets runtime deps between consecutive prerenders', async function () {
                let first = await prerenderer.prerenderCard({
                    realm: realmURL,
            ...
            test('prerenderModule returns module metadata', async function () {
                const moduleURL = `${realmURL}person.gts`;
                let result = await prerenderer.prerenderModule({
                    realm: realmURL,
                    url: moduleURL,
            ...
            test('card prerender hoists module transpile errors', async function () {
            ...
            test('card prerender surfaces actionable error for bad icon import', async function () {
            ...
            test('card prerender surfaces empty render container', async function () {
            ...
            test('card prerender surfaces runtime render errors without timing out', async function () {
            ...
            test('card prerender includes console errors when render fails', async function () {
            ...
            test('card prerender ignores console errors on success', async function () {
            ...
            test('card prerender surfaces unhandled promise rejection without timing out', async function () {
            ...
            test('card prerender surfaces RSVP rejection without timing out', async function () {
            ...
            test('card prerender surfaces errors thrown before the render model hook', async function () {
            ...
            test('card prerender waits for query fallback search and nested relationship loads', async function () {
            ...
            test('module prerender evicts pooled page on timeout', async function () {
                const moduleURL = `${realmURL}person.gts`;
                let first = await prerenderer.prerenderModule({
                    realm: realmURL,
                    url: moduleURL,
            ...
            test('file prerender returns extracted metadata', async function () {
    ...
    function defineLivePrerenderedSearchFallbackTests() {
        describe('live prerendered search fallback', function () {
            ...
            test('card prerendered search uses live rendered CardDef HTML and keeps unique CSS', async function () {
            ...
            test('card prerendered search uses live rendered FileDef HTML', async function () {
    ...
    describe('prerender - permissioned auth failures', function () {
        ...
        test('module prerender surfaces auth error without timing out', async function () {
        ...
        test('file prerender surfaces auth error without timing out', async function () {
        ...
        test('card prerender surfaces auth error without timing out', async function () {
        ...
        test('card prerender surfaces auth error from linked fetch', async function () {
            const cardURL = `${consumerRealmURL}auth-proxy-1`;
            let result = await prerenderer.prerenderCard({
                realm: consumerRealmURL,
                url: cardURL,
    ...
    describe('prerender - public query fallback', function () {
      ...
      `,
        ...
        test('card prerender in a public realm authorizes query fallback search for source-loaded linked cards', async function () {
    ...
    describe('prerender - permissioned auth failures (private query fallback)', function () {
        ...
        test('card prerender in a private realm sends auth header on query fallback federated search', async function () {
  ...
  <pre data-prerender-error>
  {
    ...
    "error": {
      ...
      "additionalErrors": null
            ...
            describe('basics', function () {
                ...
                test('isUsed field includes a field in search doc that is not rendered in template', async function () {
                ...
                test('isUsed linksToMany field includes links in search doc that are not rendered in template', async function () {
                ...
                test('isUsed compound field includes nested linksTo relationship in search doc', async function () {
                ...
                test('isUsed compound field includes nested linksToMany relationships in search doc', async function () {
                    const testCardURL = `${realmURL2}is-used-field-def`;
                    let { response } = await prerenderer.prerenderCard({
                        realm: realmURL2,
                        url: testCardURL,
                ...
                test('non-isolated formats render linked fields and those links appear in search doc', async function () {
            ...
            describe('errors', function () {
                ...
                hooks.beforeEach(disposeAllRealms);
                test('error during render', async function () {
                ...
                test('error includes blocked timer summary when timers fire', async function () {
                ...
                test('timeout includes blocked timer summary in stack', async function () {
                ...
                test('missing link surfaces 404 without eviction', async function () {
                ...
                test('fetch failed surfaces error without eviction', async function () {
                ...
                test('embedded error markup triggers render error', async function () {
                ...
                test('unusable triggers eviction and short-circuit', async function () {
                ...
                test('prerender surfaces module syntax errors without timing out', async function () {
            ...
            describe('realm pooling', function () {
                const hooks = {
                    before: beforeAll,
                    after: afterAll,
                    beforeEach,
                ...
                hooks.beforeEach(disposeAllRealms);
                test('evicts on timeout and does not reuse', async function () {
                    const testCardURL = `${realmURL2}1`;
                ...
                test('reuses the same page within a realm', async function () {
                    const testCardURL = `${realmURL2}1`;
                    let first = await prerenderer.prerenderCard({
                        realm: realmURL2,
                        url: testCardURL,
                    ...
                    expect(first.pool.realm).toBe(realmURL2);
                    expect(second.pool.realm).toBe(realmURL2);
                    expect(first.pool.pageId).toBe(second.pool.pageId);
                    expect(first.pool.reused).toBe(false);
                    expect(second.pool.reused).toBe(true);
                ...
                test('refreshes prerender session when auth changes for the same realm', async function () {
                    const testCardURL = `${realmURL2}1`;
                ...
                test('does not reuse across different realms', async function () {
                ...
                test('evicts LRU when capacity reached', async function () {
                ...
                test('serializes prerenders when only one tab is available', async function () {
                ...
                test('runs prerenders in parallel when multiple tabs are available', async function () {
                    let prevTabMax = process.env.PRERENDER_REALM_TAB_MAX;
                ...
                test('prefers idle tab aligned to realm over standby tabs', async function () {
                ...
                test('prefers standby over idle tabs from other realms', async function () {
                ...
                test('enforces per-realm tab cap by queueing on an existing tab', async function () {
                    let prevTabMax = process.env.PRERENDER_REALM_TAB_MAX;
                    let pool: PagePool | undefined;
                    let resolved = false;
                    try {
                ...
                test('queues on the least-pending tab when the realm cap is met', async function () {
                    let prevTabMax = process.env.PRERENDER_REALM_TAB_MAX;
                    let pool: PagePool | undefined;
                    let originalNow = Date.now;
                    let now = 1000;
                ...
                test('queued cross-realm requests realign the tab per request', async function () {
                    let { pool } = makeStubPagePool(1);
                    await pool.warmStandbys();
                    let first = await pool.getPage('realm-a');
                    await pool.warmStandbys();
                    ...
                    expect(pool.getWarmRealms().includes('realm-a')).toBe(true);
                    second.release();
                    blocker.release();
                    let third = await thirdPromise;
                    expect(order).toEqual(['a', 'b']);
                    expect(pool.getWarmRealms().includes('realm-b')).toBe(true);
                    third.release();
                    await pool.closeAll();
                });
                test('does not reassign a busy tab with queued work across realms', async function () {
                    ...
                    try {
                        ...
                        expect(second.pageId).toBe(first.pageId);
                        second.release();
                        expect(pool.getWarmRealms().includes('realm-b')).toBe(false);
                    }
                    finally {
                        await pool.closeAll();
                    }
                });
                test('queues same-realm request when tab is transitioning', async function () {
                    let { pool } = makeStubPagePool(1, undefined, undefined, {
                        disableStandbyRefill: true,
                    });
                    try {
                ...
                test('does not oversubscribe contexts during async eviction', async function () {
                    let prevTabMax = process.env.PRERENDER_REALM_TAB_MAX;
                    let pool: PagePool | undefined;
                    let active = 0;
                    let peak = 0;
                ...
                test('creates spare standby when pool is at capacity', async function () {
                ...
                test('standby pages bind to the first realm they serve', async function () {
                    let { pool } = makeStubPagePool(2);
                ...
                test('each tab uses a separate browser context', async function () {
                    let { pool } = makeStubPagePool(2);
                    await pool.warmStandbys();
                    let first = await pool.getPage('realm-a');
                ...
                test('evicts idle realms without touching standbys', async function () {
                    ...
                    try {
                        ...
                        expect(pool.getWarmRealms()).toEqual([]);
                ...
                test('idle eviction skips unassigned standbys', async function () {
    ...
    describe('prerender - module retries', function () {
        test('module prerender retries with clear cache on retry signature', async function () {
    ...
    describe('prerender - file retries', function () {
        test('file prerender retries with clear cache on retry signature', async function () {
    ...
    describe('prerender - card retries', function () {
        test('card prerender retries with clear cache on retry signature', async function () {
