...
import { installDelayedRuntimeRealmSearchPatch, installRealmServerAssertOwnRealmServerBypassPatch, } from './helpers/prerender-page-patches';
class TestSemaphore {
    #available: number;
...
describe("prerendering-test.ts", function () {
    describe('prerender - dynamic tests', function () {
    ...
    describe('prerender - static tests', function () {
        const hooks = createVitestNestedHooksAdapter() as any;
