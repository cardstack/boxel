...
describe("server-endpoints/webhook-receiver-test.ts", function () {
    describe('Webhook Receiver Endpoint', function () {
        ...
        test('returns 404 for unknown webhook path', async function () {
        ...
        test('returns 401 for invalid HMAC signature', async function () {
        ...
        test('returns 200 for valid HMAC_SHA256_HEADER signature with hex encoding', async function () {
            let matrixUserId = '@user:localhost';
            await insertUser(context.dbAdapter, matrixUserId, 'cus_123', 'user@example.com');
            let createResponse = await context.request2
                .post('/_incoming-webhooks')
        ...
        test('returns 200 for valid signature with base64 encoding', async function () {
            let matrixUserId = '@user:localhost';
            await insertUser(context.dbAdapter, matrixUserId, 'cus_123', 'user@example.com');
            let createResponse = await context.request2
                .post('/_incoming-webhooks')
        ...
        test('returns 401 when signature header is missing', async function () {
            let matrixUserId = '@user:localhost';
            await insertUser(context.dbAdapter, matrixUserId, 'cus_123', 'user@example.com');
        ...
        test('is a public endpoint (no JWT required)', async function () {
            let matrixUserId = '@user:localhost';
            await insertUser(context.dbAdapter, matrixUserId, 'cus_123', 'user@example.com');
            let createResponse = await context.request2
                .post('/_incoming-webhooks')
        ...
        test('executes webhook command when signature is valid', async function () {
            let matrixUserId = '@user:localhost';
            await insertUser(context.dbAdapter, matrixUserId, 'cus_123', 'user@example.com');
            // Create webhook
        ...
        test('filters commands by event type', async function () {
            let matrixUserId = '@user:localhost';
            await insertUser(context.dbAdapter, matrixUserId, 'cus_123', 'user@example.com');
            // Create webhook
            let createWebhookResponse = await context.request2
        ...
        test('command matched by eventType filter is pending execution', async function () {
            let matrixUserId = '@user:localhost';
            await insertUser(context.dbAdapter, matrixUserId, 'cus_123', 'user@example.com');
