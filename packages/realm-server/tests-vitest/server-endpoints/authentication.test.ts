...
import { realmSecretSeed, realmServerTestMatrix, setupPermissionedRealmCached, testRealmURL, } from '../helpers';
...
describe("server-endpoints/authentication-test.ts", function () {
    describe('Realm server authentication', function () {
        ...
        it('authenticates user and creates session room', async function () {
            ...
            let { status: status2, sessionRoom: sessionRoom2 } = await createRealmServerSession(matrixClient, request);
