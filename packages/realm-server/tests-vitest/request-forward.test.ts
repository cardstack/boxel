...
describe("request-forward-test.ts", function () {
    describe('Realm-specific Endpoints | _request-forward', function () {
        ...
        test('should forward request to OpenRouter and deduct credits', async function () {
        ...
        test('should reject non-whitelisted endpoints', async function () {
        ...
        test('should handle streaming requests', async function () {
            // Mock external fetch calls
            const originalFetch = global.fetch;
            const mockFetch = sinon.stub(global, 'fetch');
        ...
        test('should reject streaming for non-streaming endpoints', async function () {
            const jwt = createRealmServerJWT({ user: '@testuser:localhost', sessionRoom: 'test-session-room' }, realmSecretSeed);
            const response = await request
                .post('/_request-forward')
                .set('Accept', 'application/json')
        ...
        test('should handle insufficient credits', async function () {
        ...
        test('should handle missing authentication token', async function () {
            const response = await request
                .post('/_request-forward')
                .set('Accept', 'application/json')
                .set('Content-Type', 'application/json')
        ...
        test('should handle invalid request body', async function () {
            const jwt = createRealmServerJWT({ user: '@testuser:localhost', sessionRoom: 'test-session-room' }, realmSecretSeed);
            const response = await request
                .post('/_request-forward')
                .set('Accept', 'application/json')
        ...
        test('should forward request to Google Custom Search API with URL parameter authentication', async function () {
            // Mock external fetch calls
            const originalFetch = global.fetch;
            const mockFetch = sinon.stub(global, 'fetch');
        ...
        test('should forward request to Cloudflare AI Gateway with custom header token authentication', async function () {
            // Mock external fetch calls
            const originalFetch = global.fetch;
            const mockFetch = sinon.stub(global, 'fetch');
        ...
        test('should forward multipart form data when multipart flag is set', async function () {
            const originalFetch = global.fetch;
            const mockFetch = sinon.stub(global, 'fetch');
        ...
        test('should return a 400 when multipart payload is not an object', async function () {
            const jwt = createRealmServerJWT({ user: '@testuser:localhost', sessionRoom: 'test-session-room' }, realmSecretSeed);
            const response = await request
                .post('/_request-forward')
                .set('Accept', 'application/json')
