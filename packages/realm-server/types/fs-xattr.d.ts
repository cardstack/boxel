// we declare a type module here so the upstream can be parsed by glint as esm
// this version is compatible with 0.4.0 release
declare module 'fs-xattr' {
   ...
   */
  export function setAttributeSync(
    path: string,
    attr: string,
    value: Buffer | string,
  ): void;
