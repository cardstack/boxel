...
WAIT_ON_TIMEOUT=900000 SKIP_EXPERIMENTS=true CATALOG_KEEP_DIRS='fields,catalog-app' CATALOG_INDEX_SOURCE='grid.json' NODE_NO_WARNINGS=1 start-server-and-test \
