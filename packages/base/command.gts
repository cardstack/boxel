...
export class FileContentInput extends CardDef {
...
export class ApplySearchReplaceBlockInput extends FileContentInput {
...
export class LintAndFixInput extends FileContentInput {
  @field realm = contains(StringField);
}
