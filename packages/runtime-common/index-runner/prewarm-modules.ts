...
// Lattice's 10x fixture has millions of repeated dependency strings. Consume
...
const LATTICE_PREWARM_DEPENDENCY_BATCH_SIZE = 250;
...
export async function preWarmModulesTable({
  ...
  for (
    ...
    offset += LATTICE_PREWARM_DEPENDENCY_BATCH_SIZE
  ) {
