...
import BoxelIconDropdownButton from './index.gts';

export default class IconDropdownButtonUsageComponent extends Component {
  @tracked label = 'Label';
  ...
  <template>
    <FreestyleUsage @name='IconDropdownButton'>
      <:example>
        <BoxelIconDropdownButton
          @label={{this.label}}
          @icon={{this.icon}}
          @size={{this.size}}
