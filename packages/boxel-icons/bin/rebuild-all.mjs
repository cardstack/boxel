...
// Only the JSON FileDef icon ships a static SVG artifact in this draft.
// Add other names together with their generated source artifacts.
const staticSVGNames = new Set(['json']);
...
__STATIC_ICON_SVG__export default IconComponent;
`;
...
for (const c of componentsToGenerate) {
  ...
  const staticSVG = staticSVGNames.has(c.rawName)
    ? `Object.defineProperty(IconComponent, Symbol.for('boxel:static-icon-svg'), {
  value: Object.freeze(${JSON.stringify({
    svg: contents,
