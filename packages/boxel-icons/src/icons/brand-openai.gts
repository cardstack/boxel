...
const IconComponent: TemplateOnlyComponent<Signature> = <template>
  ...
  ><path stroke='none' d='M0 0h24v24H0z' /><path
      d='M11.217 19.384A3.501 3.501 0 0 0 18 18.167V13l-6-3.35'
    /><path
      d='M5.214 15.014A3.501 3.501 0 0 0 9.66 20.28L14 17.746V10.8'
    /><path
    ...
    /><path d='M12.783 4.616A3.501 3.501 0 0 0 6 5.833V10.9l6 3.45' /><path
      d='M18.786 8.986A3.501 3.501 0 0 0 14.34 3.72L10 6.254V13.2'
    /><path
...
IconComponent.name = 'brand-openai';
