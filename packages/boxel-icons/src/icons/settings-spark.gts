...
const IconComponent: TemplateOnlyComponent<Signature> = <template>
  ...
  ><path stroke='none' d='M0 0h24v24H0z' /><path
    ...
    /><path
      d='M9 12a3 3 0 1 0 6 0 3 3 0 0 0-6 0M19 22.5a4.75 4.75 0 0 1 3.5-3.5 4.75 4.75 0 0 1-3.5-3.5 4.75 4.75 0 0 1-3.5 3.5 4.75 4.75 0 0 1 3.5 3.5'
    /></svg>
</template>;

// @ts-expect-error this is the only way to set a name on a Template Only Component currently
IconComponent.name = 'settings-spark';
