...
const IconComponent: TemplateOnlyComponent<Signature> = <template>
  ...
  ><path stroke='none' d='M0 0h24v24H0z' /><path
      d='m9 15 3-3m2-2 1-1M9.148 9.145A.498.498 0 0 0 9.5 10a.5.5 0 0 0 .35-.142M14.148 14.145A.498.498 0 0 0 14.5 15a.5.5 0 0 0 .35-.142'
    /><path
...
IconComponent.name = 'rosette-discount-off';
