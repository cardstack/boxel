...
const IconComponent: TemplateOnlyComponent<Signature> = <template>
  ...
  ><path stroke='none' d='M0 0h24v24H0z' /><path
    ...
    /><path d='M12 12a8 8 0 0 0 8 4M7.5 13.5A12 12 0 0 0 16 20' /><path
      d='M12 12a8 8 0 0 0-7.464 4.928M12.951 7.353a12 12 0 0 0-9.88 4.111'
    /><path
      d='M12 12a8 8 0 0 0-.536-8.928M15.549 15.147a12 12 0 0 0 1.38-10.611'
    /></svg>
</template>;

// @ts-expect-error this is the only way to set a name on a Template Only Component currently
IconComponent.name = 'ball-volleyball';
