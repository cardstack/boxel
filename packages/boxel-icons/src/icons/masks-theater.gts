...
const IconComponent: TemplateOnlyComponent<Signature> = <template>
  ...
  ><path stroke='none' d='M0 0h24v24H0z' /><path
    ...
    /><path
      d='M15 16.5q1.5 1 3 0M8.632 15.982A4 4 0 0 1 8.25 16h-1.5a4 4 0 0 1-3.983-3.635L2.2 6.183A2 2 0 0 1 4.192 4h6.616a2 2 0 0 1 2 2M6 8h.01M9 8h.01'
    /><path d='M6 12q1.146-.765 2.291-.36' /></svg>
</template>;
