...
module('getModifyPrompt', (hooks) => {
 ...
 User UI context:
- is operating in a realm with this URL: http://my-realm.com
- is operating in code mode
- is inspecting the file contents in this code mode panel: playground
- is viewing this card instance in the playground UI: http://localhost:4201/postcards/1, in this format: isolated`,
    );
    assert.equal(
