  ...
  static isolated = class Isolated extends Component<typeof this> {
      ...
      this.liveQuery = getLiveCards(
        {
          filter: {
            type: {
              name: tabRef.name,
              module: tabRef.module.replace('../', realm),
            },
          },
        },
        realm ? [this.args.model[realmURL].href] : undefined,
    ...
    private createCard = restartableTask(async () => {
      ...
      let tabRef = {
        ...
        module: this.activeTab.ref.module.replace('../', realm),
      };
    ...
    async setupInitialTabs() {
      ...
      let module = await loader.import<object>(realm + this.moduleName);
    ...
    <template>
      {{#if this.noTabs}}
        ...
        >
          <p style='margin-bottom: 20px; font-size: 16px;'>It looks like this
            app hasn't been setup yet. For a quick setup, enter the module name
            and click create.</p>
