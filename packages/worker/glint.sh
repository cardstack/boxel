...
maybe_deprecations=$(pnpm glint 2>&1 | perl -p0e "s/[^\n]*Cannot find name '(HTMLElement|ShadowRoot|HTMLDialogElement|HTMLInputElement|HTMLTextAreaElement|HTMLElementTagNameMap|CSSStyleSheet|CSSStyleRule|Node|DocumentOrShadowRoot)'[^\n]*[\n]*[^\n]*[\n]*[^\n]*[\n]*//smg")
