...
class IsolatedSecForSaleHud extends Component<typeof SaleHud> {
  ...
  <template>
    ...
    <div class='sale-hud'>
      ...
      <section class='sale-hud-container'>
...
export class SaleHud extends CardDef {
  static displayName = 'Sale hud';
  ...
  static isolated = IsolatedSecForSaleHud;
}
