...
export class ContractTemplate extends CardDef {
   ...
   */
  /**
   * Edit — a template: identity, the clauses it assembles, the body around them.
   ...
   */
  static edit = class Edit extends Component<typeof ContractTemplate> {
    @tracked activeSection = 'identity';

    sections = [
      { id: 'identity', label: 'Identity' },
      { id: 'clauses', label: 'Clause assembly' },
      { id: 'text', label: 'Body & guidance' },
    ];

    goTo = (id: string, event: Event) => {
      this.activeSection = id;
      let root = (event.currentTarget as HTMLElement).closest('.ctemplate-edit');
      root
      ...
      <div class='ctemplate-edit'>
        ...
        <div class='edit-body'>
          ...
          <div class='sects'>
            ...
            >
              <h3>Identity</h3>
              <FieldContainer @label='Template name' @vertical={{true}}>
                <@fields.templateName />
              </FieldContainer>
              <div class='row cols-3'>
                <FieldContainer @label='Contract type' @vertical={{true}}>
                  <@fields.contractType />
                </FieldContainer>
                <FieldContainer @label='Use case' @vertical={{true}}>
                  <@fields.useCase />
                </FieldContainer>
                <FieldContainer @label='Published' @vertical={{true}}>
                  <@fields.isPublished />
                </FieldContainer>
              </div>
            ...
            <section
              class='sect {{if (eq this.activeSection "clauses") "focused"}}'
              data-sect='clauses'
            >
              <h3>Clause assembly
                <span class='sect-hint'>the library clauses a new contract starts from</span></h3>
              <FieldContainer @label='Standard clauses' @vertical={{true}}>
                <@fields.standardClauses />
              </FieldContainer>
              <FieldContainer @label='Inputs the drafter must supply' @vertical={{true}}>
            ...
            >
              <h3>Body & guidance</h3>
              <FieldContainer @label='Body (markdown)' @vertical={{true}}>
                <@fields.bodyMarkdown />
              </FieldContainer>
              <FieldContainer @label='Drafting guidance' @vertical={{true}}>
                <@fields.guidance />
              </FieldContainer>
            </section>
          </div>
