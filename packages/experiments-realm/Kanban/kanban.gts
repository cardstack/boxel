...
import { KanbanPlane } from './Layout/kanban-plane'; // ¹²
import { KanbanDragManager } from './Layout/kanban-drag'; // ¹³
import { type KanbanPlacement, autoPlaceKanban } from './Layout/kanban-engine'; // ¹⁴
...
class Isolated extends Component<typeof KanbanCard> {
  // ¹⁹
      ...
      <header class='kanban-toolbar'>
        <div class='toolbar-left'>
          <h2 class='kanban-title'>
            ...
            {{if @model.title @model.title 'Untitled Kanban'}}
          </h2>
