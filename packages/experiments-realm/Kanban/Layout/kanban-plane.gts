  ...
  <template>
    ...
    <style scoped>
      {{! ¹⁶ }}/* ── Board ──────────────────────────────────────────────────── */
            ...
            .board:focus-visible { box-shadow: inset 0 0 0 2px var(--ring, #3b82f6); }
            .board.is-dragging { user-select: none; -webkit-user-select: none; cursor: grabbing; }
            ...
            .column.is-over-wip { background: #fef3c7; }
            ...
            .col-wip.over { color: #d97706; font-weight: 600; }
            ...
            .card.selected {
              box-shadow: 0 0 0 2px var(--primary, #3b82f6), 0 1px 2px rgba(0, 0, 0, 0.06);
            }
            .card.dragging {
              opacity: 0;
              height: 0;
