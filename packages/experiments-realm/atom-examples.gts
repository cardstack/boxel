...
export class AtomExamples extends CardDef {
  ...
  @field teamMember = linksTo(TeamMember, { searchable: true });
  @field teamMembers = linksToMany(TeamMember, { searchable: true });
  @field company = linksTo(Company, { searchable: true });
  @field companies = linksToMany(Company, { searchable: true });
  @field contact = linksTo(Contact, { searchable: true });
  @field contacts = linksToMany(Contact, { searchable: 'company' });
