...
> **Companion doc:** `references/libraries.md` covers import-path mechanics in more detail. This file covers the _capability_ dimension — what each surface lets you DO.
