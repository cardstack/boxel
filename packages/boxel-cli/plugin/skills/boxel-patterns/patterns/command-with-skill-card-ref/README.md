...
**When to use:** The card has a clear "send to AI for help" affordance — generating a report, suggesting an avatar, kicking off classification, drafting a response. Any time a card wants to _delegate_ to an LLM with framing.
