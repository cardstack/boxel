...
- **App-card hubs.** When a CardDef is the _one_ place a user goes to manage an entity over time, and they need quick jumps between domains (Identity / Medical / Financial / Custody / IEP, or whatever your domain shape is).
