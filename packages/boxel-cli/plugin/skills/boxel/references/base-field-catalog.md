...
| `CurrencyField` _(via `currency.gts`)_ | `'https://cardstack.com/base/currency'`             | Standalone currency code (USD/EUR/etc) for lookup tables.        |
...
| Field                 | Import                                           | Notes                                                                 |
| --------------------- | ------------------------------------------------ | --------------------------------------------------------------------- |
| `FileDef` _(generic)_ | `'https://cardstack.com/base/file-api'`          | Generic file slot. Use a specific subtype when possible.              |
