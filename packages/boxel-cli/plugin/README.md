...
_Copied from [`cardstack/boxel-skills@v0.1.1`](https://github.com/cardstack/boxel-skills/tree/v0.1.1) by_ `pnpm build:skills`. _Edit upstream, not here._

| Skill                                       | Use it for                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| ------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `/boxel-cli:boxel`                          | Use whenever creating, reading, or editing Boxel cards (.gts files), card instances (.json), fields, templates, queries, or anything in a Boxel realm. Required for any Boxel coding work — covers CardDef, FieldDef, contains/linksTo, templates, formats, queries, and core patterns. Companion skills - boxel-design (visual decisions), boxel-ui-guidelines (template UI), source-code-editing (run-realm-code), boxel-environment (running the Boxel app).                                                                                                                                                              |
...
| `/boxel-cli:source-code-editing`            | Use when editing existing .gts or .json files with the run-realm-code tool. Defines the isolated editing workflow and recovery from failed tool calls. Required before issuing any code edit.                                                                                                                                                                                                                                                                                                                                                                                                                                |
