...
| `/boxel-cli:boxel-environment`               | Help users navigate Boxel efficiently, switching between modes and orchestrating workflows                                                                                                                                                                                                                           |
...
| `/boxel-cli:env-creating-and-editing-cards`  | Quick reference for choosing the right combination of commands to create new cards or update existing ones                                                                                                                                                                                                           |
| `/boxel-cli:env-sim-boxel-environment-guide` | Help users navigate Boxel efficiently, switching between modes and orchestrating workflows                                                                                                                                                                                                                           |
