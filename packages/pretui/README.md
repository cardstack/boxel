...
components/button-spec.json    the component's Spec instance
...
Instance ids are dot-free, so the Spec instance is `<name>-spec.json` with a hyphen while files fetched by extension take dot suffixes.
