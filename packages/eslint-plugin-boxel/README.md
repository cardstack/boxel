...
| [no-reserved-field-names](docs/rules/no-reserved-field-names.md)           | disallow `@field` declarations under names the system reserves for its own getters (e.g. `captureURLs`)                                                                          | ✅  |     |
