...
function buildSeedIssueDocument(
  ...
  let description = [
    ...
    `   - Issue #1: Create card definition and tests (priority: high, order: 1)`,
    `   - Issue #2: Create catalog spec with examples (priority: medium, order: 2, blockedBy: issue #1)`,
    ``,
  ...
  let acceptanceCriteria = [
    ...
    '- [ ] Implementation issue #1: card definition and tests',
    '- [ ] Implementation issue #2: catalog spec with examples',
