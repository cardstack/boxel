...
module('factory-tool-builder > tool building', function () {
  test('builds factory-level tools plus registered tools', function (assert) {
    ...
    // The 7 surviving factory tools after CS-11034: 5 validators + 2
    // control signals. Native fs / Bash / Glob / Grep are owned by
    // the agent backend (Claude Agent SDK or opencode).
