...
import { fn, mut, array } from '@ember/helper';
import { BoxelSelect } from '@cardstack/boxel-ui/components'; // ² BoxelSelect component
import { eq, not } from '@cardstack/boxel-ui/helpers'; // ³ Helpers
...
export class RecurringPatternField extends FieldDef {
  ...
  // ¹⁷ Edit format - full recurrence pattern editor
  static edit = class Edit extends Component<typeof this> {
    ...
    saveToModel() {
      ...
      this.args.model.startDate = this.startDate || null;
      this.args.model.endDate = this.endDate || null;
      this.args.model.occurrences = this.occurrences;
      this.args.model.interval = this.interval;
      this.args.model.daysOfWeek =
        this.daysOfWeekArray.length > 0 ? this.daysOfWeekArray.join(',') : null;
