...
export class StudySession extends CardDef {
  ...
  static isolated = class Isolated extends Component<typeof StudySession> {
    ...
    get sessionAnalysis() {
      try {
        ...
        const effectiveness = this.args?.model?.effectiveness || 100;
          ...
          <section class='session-metrics'>
            ...
            <div class='metrics-grid'>
              ...
              <div class='metric-card duration-card'>
                ...
                {{#if
                  (and @model.plannedDuration (gt @model.plannedDuration 0))
                }}
                  ...
                  <div class='timing-breakdown'>
                    <div class='timing-item'>
                      ...
                      <span class='timing-value'>{{formatDuration
                          (multiply @model.plannedDuration 60)
                          unit='seconds'
                          format='humanize'
                        }}</span>
                    </div>
                    <div class='timing-item'>
                      ...
                      <span class='timing-value'>{{formatDuration
                          (multiply @model.actualDuration 60)
                          unit='seconds'
                          format='humanize'
                        }}</span>
                    </div>
