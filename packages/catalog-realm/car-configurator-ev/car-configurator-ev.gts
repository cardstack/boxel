...
export class CarConfiguratorEV extends CardDef {
  ...
  static isolated = class Isolated extends Component<typeof this> {
    ...
    toggleFeature(feature: string) {
      if (feature === 'autopilot') this.args.model.autopilotEnabled = !this.args.model.autopilotEnabled;
    ...
    @action
    selectColor(colorName: string, colorValue: string) {
          ...
          <section class='config-panel'>
                    ...
                    {{#each @model.wheelOptions as |wheelOption|}}
                      <button
                        class={{this.getOptionCardClass
                          wheelOption
                          (if
                            @model.selectedWheels @model.selectedWheels.name ''
                          )
                        }}
                        {{on
                          'click'
            ...
            <div class="config-section">
                ...
                <div class="feature-list">
                  <label class="feature-toggle {{if @model.autopilotEnabled 'enabled'}}">
                    <input type="checkbox" checked={{@model.autopilotEnabled}} {{on 'change' (fn this.toggleFeature 'autopilot')}}>
                  ...
                  <label class="feature-toggle {{if @model.premiumAudioEnabled 'enabled'}}">
                    <input type="checkbox" checked={{@model.premiumAudioEnabled}} {{on 'change' (fn this.toggleFeature 'audio')}}>
                    <div class="toggle-content">
                  ...
                  <label class="feature-toggle {{if @model.sunroofEnabled 'enabled'}}">
                    <input type="checkbox" checked={{@model.sunroofEnabled}} {{on 'change' (fn this.toggleFeature 'sunroof')}}>
                    <div class="toggle-content">
                      <h3>Glass Canopy</h3>
        ...
        <div class="edit-layout {{if this.isOptionsPanelCollapsed 'collapsed'}}">
          ...
          <div class="options-panel">
            <div class="options-panel-header">
              ...
              <button 
                class="toggle-button {{if this.isOptionsPanelCollapsed 'collapsed'}}"
                {{on 'click' this.toggleOptionsPanel}}
                title="{{if this.isOptionsPanelCollapsed 'Expand Options Panel' 'Collapse Options Panel'}}"
              >
          ...
          <div class="configuration-panel">
            ...
            <div class="config-section">
              ...
              <div class="config-field">
                <label class="field-label">Surreal Sound Pro (Premium Audio) - $2,500</label>
