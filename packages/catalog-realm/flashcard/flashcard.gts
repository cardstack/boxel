...
import { formatDateTime, eq, and, gt } from '@cardstack/boxel-ui/helpers'; // ³ Formatters
...
export class FlashcardCard extends CardDef {
  ...
  static isolated = class Isolated extends Component<typeof FlashcardCard> {
  ...
  static embedded = class Embedded extends Component<typeof FlashcardCard> {
