...
import { formatFileSize, and, gt } from '@cardstack/boxel-ui/helpers'; // ³ Helpers
import CubeIcon from '@cardstack/boxel-icons/cube'; // ⁴ Icon import

// ⁵ Direct Three.js imports using +esm for better module resolution
import * as THREE from 'https://esm.sh/three@0.160.0';
import { OrbitControls } from 'https://esm.sh/three@0.160.0/examples/jsm/controls/OrbitControls.js';
import { GLTFLoader } from 'https://esm.sh/three@0.160.0/examples/jsm/loaders/GLTFLoader.js';
// ⁶ Canvas modifier for Three.js initialization
class ThreeCanvasModifier extends Modifier {
...
export class GltfViewer extends CardDef {
  ...
  // ¹² Isolated format with full 3D viewer
    ...
    private initializeScene = task(async () => {
      try {
        ...
        this.controls.autoRotate =
          this.args.model?.settings?.autoRotate ?? false;
          ...
          {{#if this.loadModel.isRunning}}
            <div class='loading-overlay'>
              <div class='loading-content'>
                ...
                {{#if (and this.loadingProgress (gt this.loadingProgress 0))}}
        ...
        {{#if this.isModelLoaded}}
          <footer class='viewer-footer'>
            <div class='model-info'>
              <span class='status-indicator success'>Model Loaded</span>
              {{#if @model.modelUrl}}
                <a
                  href={{@model.modelUrl}}
                  target='_blank'
  ...
  // ²⁰ Embedded format for card listings
  static embedded = class Embedded extends Component<typeof this> {
    <template>
      <div class='gltf-card'>
  ...
  static fitted = class Fitted extends Component<typeof this> {
    <template>
      ...
      <style scoped>
        /* ²³ Fitted format responsive styles */
        .fitted-container {
          container-type: size;
          width: 100%;
          height: 100%;
