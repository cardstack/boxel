...
export class StudyGoal extends CardDef {
  ...
  static isolated = class Isolated extends Component<typeof StudyGoal> {
    ...
    editGoal() {
      ...
      if (this.args?.context?.actions?.viewCard) {
        this.args.context.actions.viewCard(this.args.model, 'edit');
      }
    }
                      ...
                      <div class='milestone-section'>
                        ...
                        <div class='milestone-buttons'>
                          ...
                          <button
                            class='milestone-btn
                              {{if
                                (eq this.progressPercentage 100)
                                "active"
                                ""
                              }}'
                  ...
                  {{else}}
                    <div class='progress-overview'>
                      ...
                      <div class='status-insight {{@model.status}}'>
                        ...
                        {{else if (eq @model.status 'overdue')}}
                          ⚠️ This goal is overdue. Consider updating the
                          deadline or prioritizing completion.
                        {{else if (eq @model.status 'urgent')}}
                        ...
                        {{else if (eq @model.status 'in-progress')}}
                          ...
                          completion.
                        {{else}}
                          📋 Ready to start? Click "Edit" to update your
                          progress.
                        {{/if}}
                      </div>
                    </div>
  ...
  static embedded = class Embedded extends Component<typeof StudyGoal> {
