...
class RelativeTimeFieldSpecIsolated extends Component<
  typeof RelativeTimeFieldSpec
> {
  <template>
...
class RelativeTimeFieldSpecEdit extends Component<
  typeof RelativeTimeFieldSpec
> {
  <template>
    <article class='container'>
...
export class RelativeTimeFieldSpec extends Spec {
  ...
  // Standard RelativeTimeField configuration
  @field standard = contains(RelativeTimeField);

  static isolated =
    RelativeTimeFieldSpecIsolated as unknown as typeof Spec.isolated;
  static edit = RelativeTimeFieldSpecEdit as unknown as typeof Spec.edit;
}
