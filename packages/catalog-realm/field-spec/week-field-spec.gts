...
import WeekField from 'https://cardstack.com/base/date/week';
import CodeSnippet from '../components/code-snippet';

const standardFieldCode = `@field standard = contains(WeekField);`;

class WeekFieldSpecIsolated extends Component<typeof WeekFieldSpec> {
  <template>
...
class WeekFieldSpecEdit extends Component<typeof WeekFieldSpec> {
  <template>
    <article class='container'>
...
export class WeekFieldSpec extends Spec {
  ...
  // Standard WeekField configuration
  @field standard = contains(WeekField);

  static isolated = WeekFieldSpecIsolated as unknown as typeof Spec.isolated;
  static edit = WeekFieldSpecEdit as unknown as typeof Spec.edit;
}
