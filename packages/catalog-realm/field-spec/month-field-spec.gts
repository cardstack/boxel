...
import MonthField from 'https://cardstack.com/base/date/month';
import CodeSnippet from '../components/code-snippet';

const standardFieldCode = `@field standard = contains(MonthField);`;

class MonthFieldSpecIsolated extends Component<typeof MonthFieldSpec> {
  <template>
...
class MonthFieldSpecEdit extends Component<typeof MonthFieldSpec> {
  <template>
    <article class='container'>
...
export class MonthFieldSpec extends Spec {
  ...
  // Standard MonthField configuration
  @field standard = contains(MonthField);

  static isolated = MonthFieldSpecIsolated as unknown as typeof Spec.isolated;
  static edit = MonthFieldSpecEdit as unknown as typeof Spec.edit;
}
