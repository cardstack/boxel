...
class DateTimePreviewIsolated extends Component<typeof DateTimePreview> {
  ...
  get selectedPresentation() {
    ...
    return this.availablePresentationOptions.find((opt) => opt.value === value);
  }
        ...
        <div class='playground-card'>
          <div class='playground-column'>
            ...
            <div class='playground-demo'>
              ...
              {{else if (eq this.currentPlaygroundField 'playgroundMonthYear')}}
              ...
              {{else if (eq this.currentPlaygroundField 'playgroundDateRange')}}
                <@fields.playgroundDateRange @format='edit' />
              {{else if (eq this.currentPlaygroundField 'playgroundTimeRange')}}
                <@fields.playgroundTimeRange @format='edit' />
              {{else if (eq this.currentPlaygroundField 'playgroundDuration')}}
...
export class DateTimePreview extends CardDef {
  ...
  static isolated = DateTimePreviewIsolated;
}
