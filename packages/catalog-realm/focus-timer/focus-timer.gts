...
import { Button, Pill, CardContainer } from '@cardstack/boxel-ui/components'; // ² Enhanced UI components
import {
  formatDateTime,
  formatDuration,
  eq,
...
export class FocusTimerCard extends CardDef {
  ...
  @field sessionEfficiency = contains(NumberField, {
    computeVia: function (this: FocusTimerCard) {
      try {
        const completed = this.sessionsCompleted || 0;
        const target = this.targetSessions || 4;
  ...
  static isolated = class Isolated extends Component<typeof FocusTimerCard> {
    ...
    startSession() {
      try {
        ...
        this.currentCycleNumber =
          (this.args?.model?.sessionsCompleted || 0) + 1;
        this.isRunning = true;
    ...
    timerTask = restartableTask(async () => {
      try {
        ...
        if (this.currentTime === 0 && this.isRunning) {
          if (this.currentPhase === 'focus') {
            this.completeCurrentFocus();
            // Continue to break if not all sessions complete
            if (this.currentPhase === 'break') {
              this.timerTask.perform();
            }
          } else if (this.currentPhase === 'break') {
            this.startNextFocusSession();
            // Continue with next focus session
            if (this.currentPhase === 'focus') {
              this.timerTask.perform();
            }
          }
        ...
        <div class='timer-container'>
          ...
          <div class='timer-controls'>
            ...
            <div class='secondary-controls'>
              {{#if
                (or
                  (eq this.currentPhase 'focus') (eq this.currentPhase 'break')
                )
              }}
                <Button
            ...
            <div class='session-stats'>
              <div class='stats-row'>
                <div class='stat-card'>
                  ...
                  <div class='stat-content'>
                    <span class='stat-value'>{{formatDuration
                        (multiply @model.focusDuration 60)
                        unit='seconds'
                        format='humanize'
                      }}</span>
                ...
                <div class='stat-card'>
                  ...
                  <div class='stat-content'>
                    <span class='stat-value'>{{formatDuration
                        (multiply @model.breakDuration 60)
                        unit='seconds'
                        format='humanize'
                      }}</span>
            ...
            <div class='progress-circle'>
              <svg class='circle-progress' viewBox='0 0 100 100'>
                ...
                <circle
                  ...
                  stroke-dashoffset={{subtract
                    283
                    (multiply @model.completionPercentage 2.83)
                  }}
                  stroke-linecap='round'
              ...
              <div class='progress-ring'>
                <svg viewBox='0 0 60 60'>
                  ...
                  <circle
                    ...
                    stroke-dashoffset={{subtract
                      157
                      (multiply @model.completionPercentage 1.57)
                    }}
                    stroke-linecap='round'
                  ...
                  <div class='large-progress-ring'>
                    <svg viewBox='0 0 80 80'>
                      ...
                      <circle
                        ...
                        stroke-dashoffset={{subtract
                          220
                          (multiply @model.completionPercentage 2.2)
                        }}
                        stroke-linecap='round'
