# Style Reference Generation Plan
...
Mark style reference as "Has Instance" as Yes

## Step 5

Create a ThemeListing listing based upon 

- uses name "style" as the name
- puts inpirations and visual dna into summary
- links style reference spec
<!-- - create a brand guide that links the instance of the style reference -->
