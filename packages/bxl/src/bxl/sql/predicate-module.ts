...
`,
  mappings: [
    ...
    {
      syntax: 'a BETWEEN lo AND hi',
      jq: 'between(a; lo; hi)',
      sql: 'a BETWEEN lo AND hi',
    },
    {
      syntax: 'a NOT BETWEEN lo AND hi',
      jq: 'between(a; lo; hi) | not',
      sql: 'a NOT BETWEEN lo AND hi',
    },
    {
      syntax: 'a LIKE "fish%"',
      jq: 'like(a; "fish%")',
      sql: 'a LIKE ?',
      notes: '% and _ are SQL LIKE wildcards inside the pattern string.',
    },
    {
      syntax: 'a NOT LIKE "%fish%"',
      jq: 'like(a; "%fish%") | not',
      sql: 'a NOT LIKE ?',
      notes: 'No wildcard means exact string match.',
    },
  ],
};
