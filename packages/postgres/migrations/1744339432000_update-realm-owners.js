      ...
      pgm.sql(
        `INSERT INTO realm_user_permissions (realm_url, username, read, write, realm_owner)
         VALUES
           ...
           ('https://cardstack.com/catalog/', '@catalog_realm:stack.cards', true, true, true),
           ('https://cardstack.com/catalog/', '*', true, false, false),
      ...
      pgm.sql(
        `INSERT INTO realm_user_permissions (realm_url, username, read, write, realm_owner)
         VALUES
           ...
           ('https://cardstack.com/catalog/', '@catalog_realm:boxel.ai', true, true, true),
           ('https://cardstack.com/catalog/', '*', true, false, false),
      ...
      pgm.sql(
        `INSERT INTO realm_user_permissions (realm_url, username, read, write, realm_owner)
         VALUES
           ...
           ('https://cardstack.com/catalog/', '@catalog_realm:localhost', true, true, true),
           ('https://cardstack.com/catalog/', '*', true, false, false),
